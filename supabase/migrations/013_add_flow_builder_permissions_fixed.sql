-- Migration: Adicionar permissões do Flow Builder ao sistema RBAC (CORRIGIDA)
-- Arquivo: 013_add_flow_builder_permissions_fixed.sql
...
-- ====================
-- 2. ADICIONAR POLÍTICAS RLS PARA FLOW BUILDER (COM VERIFICAÇÃO)
-- ====================
