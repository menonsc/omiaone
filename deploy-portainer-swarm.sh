...
# Script para deploy do stack no Portainer Docker Swarm
# Uso: ./deploy-portainer-swarm.sh

set -e

echo "🚀 Iniciando deploy do stack Agentes de IA no Docker Swarm..."
...
docker stack deploy -c portainer-stack-swarm.yml agentes-ia
